...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseBodyExceptionDetails> handleValidationException(
            ValidationException validationException
    ) {
        return makeResponse(HttpStatus.CONFLICT, validationException.getMessage(), validationException);
    }

    private ResponseEntity<ResponseBodyExceptionDetails> makeResponse(
            HttpStatus status,
            String message,
            Exception exception
    ) {
