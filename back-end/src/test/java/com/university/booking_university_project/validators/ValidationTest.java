...
public class ValidationTest {
    ...
    public void validateTrimSpacesThrowIfContains() {
        ...
        Assertions.assertThrows(
                ...
                () -> Validation.validateTrimSpaces(beginning),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateTrimSpaces(end),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateTrimSpaces(both),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateTrimSpaces(multiple),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateTrimSpaces(whiteSpaces),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
    }
    ...
    public void validateStringIsNullOrEmptyThrowIfItIs() {
        ...
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateObjectNullOrEmpty(empty),
                ExceptionMessage.FIELD_NULL_OR_EMPTY_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateObjectNullOrEmpty(null),
                ExceptionMessage.FIELD_NULL_OR_EMPTY_VALIDATION_MESSAGE
        );
    }
    ...
    public void everyValidationShouldThrowIfStringContainsTrimSpaces() {
        ...
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateUserFirstName(string),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateUserSurname(string),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
        ...
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validatePhone(string),
                ExceptionMessage.TRIM_VALIDATION_MESSAGE
        );
    }
    ...
    public void validateUserFirstNameThrowIfUserFirstnameIsNullOrEmpty() {
        ...
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateUserFirstName(userFirstName),
                ExceptionMessage.FIELD_NULL_OR_EMPTY_VALIDATION_MESSAGE
        );
        Assertions.assertThrows(
                ValidationException.class,
                () -> Validation.validateUserFirstName(null),
                ExceptionMessage.FIELD_NULL_OR_EMPTY_VALIDATION_MESSAGE
        );
    }
