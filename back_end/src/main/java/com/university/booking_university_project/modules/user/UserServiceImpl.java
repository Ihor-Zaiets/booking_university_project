...
public class UserServiceImpl implements UserService {
    ...
    public List<UserDTO> createUsers(List<UserCreateDTO> userCreationDTOList) {
        ...
        for (
            UserCreateDTO userCreationDTO : userCreationDTOList
        ) {
    ...
    public List<UserDTO> editUsers(List<UserUpdateDTO> userUpdateDTOList) {
        List<User> users = new ArrayList<>();
        for (
            UserUpdateDTO userUpdateDTO : userUpdateDTOList
        ) {
    ...
    private void validateUserCreation(UserCreateDTO userUpdateDTO) {
        ...
        Validation.validatePhoneWithMessagePrefix(
                userUpdateDTO.getPhone(),
                Validation.PHONE_FIELD_EXCEPTION_MESSAGE_PREFIX + " "
        );
    }
