...
public class Validation {
    ...
    public static void validateEmail(String userEmail) {
        ...
        if (userEmail != null && !userEmail.matches(EMAIL_REGEX)) throw new ValidationException(
                ExceptionMessage.EMAIL_VALIDATION_MESSAGE
        );
    }
    ...
    public static void validatePhoneWithMessagePrefix(String userPhone, String prefix) {
        ...
        if (!userPhone.replaceAll(" ", "").matches(PHONE_REGEX)) throw new ValidationException(
                ExceptionMessage.PHONE_NUMBER_VALIDATION_MESSAGE
        );
    }
