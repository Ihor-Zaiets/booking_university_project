...
public class ApartmentServiceImplTest {
  ...
  @Autowired
  public ApartmentServiceImplTest(ApartmentRepository apartmentRepository, TestUtils testUtils, EntityService<Apartment, Integer, ApartmentRepository> entityService) {
